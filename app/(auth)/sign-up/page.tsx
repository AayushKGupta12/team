...
export default function SignInPage() {
  ...
  {[
    {
      quote:
        "Signing up gave me instant clarity on how my resume should actually look for real recruiters, not generic advice.",
      author: "Final year CS student",
      rating: 5,
    },
    {
      quote:
        "I created an account just to explore, but the role suggestions and resume feedback felt surprisingly relevant.",
      author: "Software Engineer",
      rating: 5,
    },
    {
      quote:
        "The platform feels structured and practical. It helped me understand what to focus on before applying anywhere.",
      author: "Job seeker",
      rating: 4,
    },
    {
