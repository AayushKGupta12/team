...
/*
  Sign In — Login page
  Design ref: Amna Malik Figma v2 (Desktop-4 / iPhone 13&14-4 / iPad mini 8.3-4)
  Note: the <SignIn/> widget below is rendered with NO appearance overrides —
    ...
    <div className="grid min-h-screen grid-cols-1 bg-[#e7f0fa] lg:grid-cols-2">
      ...
      <div className="flex min-h-screen flex-col">
        <div className="flex flex-1 flex-col items-center justify-center px-6 py-12">
          ...
          {/* Clerk's default SignIn — untouched, no appearance prop */}
