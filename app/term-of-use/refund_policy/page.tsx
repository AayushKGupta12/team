...
const page = () => {
  ...
  <div className="bg-white text-gray-900">
    ...
    <main className="max-w-5xl mx-auto px-6 py-16 space-y-12">
      ...
      <h1 id="terms_and_conditions" className="text-4xl font-semibold mt-25 justify-center text-center">
    ...
    <h1 id="privacy-policy" className="text-2xl font-semibold">Privacy Policy</h1>
    ...
    <h2 className="font-semibold text-lg">Security Precautions</h2>
    ...
    <h2 className="font-semibold text-lg">Data Deletion and Retention</h2>
    ...
    <h2 className="font-semibold text-lg">Grievance Officer</h2>
