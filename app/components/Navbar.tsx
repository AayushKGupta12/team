      ...
      >
        ...
        <div className={`fixed inset-y-0 right-0 w-[280px] max-w-[85vw] bg-white shadow-2xl border-l border-gray-100 
          ...
          <div className="mt-4 flex flex-col gap-3">
            <Link href="/signin">
              <button className="w-full border relative py-2 px-5 text-black text-base font-bold overflow-hidden bg-white rounded-4xl shadow-md hover:scale-105 hover:text-white hover:shadow-lg active:scale-90 before:absolute before:top-0 before:-left-full before:w-full before:h-full before:bg-gradient-to-r before:from-blue-700 before:to-blue-400 before:transition-all before:duration-500 before:ease-in-out before:z-[-1]">
                Sign In
              </button>
            </Link>
