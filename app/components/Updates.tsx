...
const updates: UpdateItem[] = [
  ...
  {
    id: '3',
    category: 'We are Hiring Interns',
  ...
  },
  {
    ...
    title: 'Join Our Marketting Team!',
    description: 'Incentive Based payment, started from 11.15% of the total revenue generated by the candidate. We’re looking for passionate marketting team to help us build the future of career intelligence.',
    date: 'April 2026',
    size: 'medium',
