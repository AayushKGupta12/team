...
const updates: UpdateItem[] = [
  ...
  {
  id: '4',
  category: 'Campus Ambassador Program',
  title: 'Become a Tauzand Campus Star 🌟',
  description:
    'Exclusive opportunity for  "Female"  B.Tech students. Get your own unique referral ID, earn exciting performance-based rewards, unlock exclusive incentives, and represent Tauzand across your university.',
  date: 'June 2026',
  size: 'medium',
