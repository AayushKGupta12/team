      ...
      <div className="w-full">
        ...
        <div className="max-w-6xl mx-auto px-6 mb-16 text-center">
          <h2 className="text-3xl md:text-4xl font-semibold text-white tracking-tight">
            Built by engineers, <span className="text-yellow-500">verified by VFound.in.</span>
          </h2>
                ...
                <div className="flex items-center justify-between mt-auto pt-6 border-t border-slate-800/50">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[12px] text-slate-500">{t.role} • {t.batch}</p>
                    </div>
                  </div>
                  ...
                  <a 
                    ...
                    className="inline-flex items-center gap-1.5 text-[12px] font-medium text-blue-400 bg-blue-950/30 px-3 py-1.5 rounded-lg border border-blue-900/50 hover:bg-blue-600 hover:text-white transition-all"
                  >
