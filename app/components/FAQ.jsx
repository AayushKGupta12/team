...
export default function FAQ() {
  ...
  },
  {
    ...
    answer:
      "We focus only on developers and the IT field. That means the Resume Analyzer, Job listings, and Roadmaps are designed specifically for software engineers, data engineers, AI engineers, and similar roles. We also provide live job updates with filters so you can quickly find the right job for your skills.",
  },
];
