...
const stats = [
  { label: "Company DSA Questions", value: 800, suffix: "+", color: "text-amber-500" },
  { label: "Chrome Extension Users", value: 1600, suffix: "K+", isDecimal: true, color: "text-emerald-500" },
  { label: "Internships Completed", value: 1634, suffix: "+", color: "text-blue-500" },
  { label: "Active Developers", value: 8000, suffix: "+", color: "text-purple-500" },
];
 ...
 */
function RollingNumber({ value, suffix, isDecimal }: { value: number; suffix: string; isDecimal?: boolean }) {
  ...
  const displayValue = useTransform(springValue, (latest) => {
    if (isDecimal) {
      // Handles the 1.6K case
      return (latest / 1000).toFixed(1);
    }
